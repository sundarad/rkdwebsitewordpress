        ...
        <div class="container">
            <div class="row justify-content-center gy-6 align-items-center">
                ...
                <div class="col-lg-6 col-md-8">
                    <img src="<?php echo get_template_directory_uri();?>/assets/img/intro-img.svg" alt="" class="img-fluid img">
                </div>
        ...
        <div class="container" data-aos="fade-up">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card mb-3">
                        <div class="card-body">
                            <h4 class="card-title">Corpoate FInance</h4>
                            <img src="assets/img/04.jpg" class="card-img-bottom" alt="...">
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <div class="icon-arrow"><i class="bi bi-chevron-right" ></i></div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Analytical goals </h4>
                            <img src="assets/img/04.jpg" class="card-img-bottom" alt="...">
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <div class="icon-arrow"><i class="bi bi-chevron-right"></i></div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="about-content" data-aos="fade-left" data-aos-delay="100">
                        ...
                        <h3><strong>9806555609</strong></h3>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="post-box">
                        <div class="post-img"><img src="assets/img/news/blog-1.jpg" class="img-fluid" alt=""></div>
                        <div class="meta">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="post-box">
                        <div class="post-img"><img src="assets/img/news/blog-2.jpg" class="img-fluid" alt=""></div>
                        <div class="meta">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="post-box">
                        <div class="post-img"><img src="assets/img/news/blog-3.jpg" class="img-fluid" alt=""></div>
                        <div class="meta">
