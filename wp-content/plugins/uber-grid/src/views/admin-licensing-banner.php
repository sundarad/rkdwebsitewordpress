...
<div class="free_version_banner" <?php if (isset($_COOKIE['portfolioGalleryBannerShow']) && $_COOKIE['portfolioGalleryBannerShow'] == "no") echo 'style="display:none"'; ?> >
    ...
    <div class="hub_image_block">
        <a target="_blank" href="https://portfoliohub.io/"><img src="https://ps.w.org/uber-grid/assets/icon-128x128.gif?rev=2210988" alt="PortfolioHub"></a>
    </div>
    ...
    <ul class="company_links">
        ...
        <li><a target="_blank" href="https://portfoliohub.io/demo/">See Demo</a></li>
